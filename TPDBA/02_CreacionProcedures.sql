...
BEGIN
    ...
    INSERT INTO Productos.Catalogo(Nombre,Precio,Proveedor,IdCategoria, PrecioRef, UnidadRef)	 --Inserta al catalogo si est· el mismo nombre ni la categoria
...
BEGIN
    ...
    INSERT INTO Complementario.CategoriaDeProds (LineaDeProducto, Producto)		--Inserta la categoria a la tabla final si no est·
