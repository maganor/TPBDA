...
BEGIN
    ...
    SET @str = REPLACE(@str, 'Ã©', 'é')
    SET @str = REPLACE(@str, 'Ã' + NCHAR(0xAD), 'í')
    SET @str = REPLACE(@str, 'Ã³', 'ó') 
    SET @str = REPLACE(@str, 'Ãº', 'ú')
	SET @str = REPLACE(@str, 'Âº', 'º')
    SET @str = REPLACE(@str, 'Ã±', 'ñ')
	SET @str = REPLACE(@str, 'å˜', 'ñ')
	SET @str = REPLACE(@str, 'Ã‘', 'ñ')
	SET @str = REPLACE(@str, 'Ãƒº', 'ú')
	SET @str = REPLACE(@str, NCHAR(0xC3) + NCHAR(0x81), 'Á')
    return @str;
END;	
GO
