...
CREATE TABLE Ventas.DetalleVentas(
    ...
    IdFactura INT,                              
    IdProducto INT,														-- Relaci�n con el producto vendido
    Cantidad INT,                                   
...
CREATE TABLE Ventas.NotasCredito (
    Id INT IDENTITY(1,1) PRIMARY KEY,							-- ID de la nota de cr�dito
    IdFactura INT,												-- ID de la factura asociada (clave for�nea)
	EstaActivo BIT NOT NULL DEFAULT 1,
